<template>
  <view class="container">
    ...
    <view class="content">
      ...
      <!-- 系统信息 -->
      <view class="section">
        <view class="system-info" @click="showSystemInfo">
          <view class="info-icon">
            <text class="info-icon-text">i</text>
          </view>
...
export default {
  ...
  methods: {
    ...
    goToOperationRecord() {
      uni.navigateTo({
        url: '/community/operation-record/operation-record'
      });
    },
    ...
    goToStrategyConfig() {
      uni.navigateTo({
        url: '/community/strategy-config/strategy-config'
      });
    },
    // 跳转到AI客服页面
    goToAIService() {
    ...
    goToMonitorData() {
      uni.navigateTo({
        url: '/community/monitor-data/monitor-data'
      });
    },
    ...
    goToQuickControl() {
      uni.navigateTo({
        url: '/community/quick-control/quick-control'
      });
    },
    ...
    goToSettings() {
      uni.navigateTo({
        url: '/community/settings/settings'
      });
    },
