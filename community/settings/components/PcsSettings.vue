...
export default {
  ...
  computed: {
    ...
    device171B() {
      return this.deviceList.find(item => item && item.deviceType === '171B')
    },
    device171F() {
    ...
    initDevice() {
      ...
      const deviceList = deviceTypes.map(deviceType => {
        ...
        return foundDevice ? {
          deviceType,
          typeCode: deviceType,
          address: foundDevice.address || (deviceType === '171B' ? '01' : '01'),
